								...
								<div class="select-wrap one-third theme">
									...
									<div class="col-md-12">
										<input type="button" id="theme_addbtn" value="테마추가"
											class="btn btn-info" onclick="check()" data-toggle="tooltip"
											data-placement="right" title="엔터키로 추가할 수 있습니다.">
							...
							<div class="col-md-12">
								<div class="select-wrap one-third theme">
									...
									<div class="custom-file" style="width: 60%">
										<input multiple="multiple" type="file" name="category_image"
											required="required" class="custom-file-input" id="customFile" />
