...
<body>
	...
	<div class="container">
		...
		<section id="dis" style="display: none; ">
			...
			<form action="PackageInsert.ma" class="p-5 bg-light" method="post" enctype="multipart/form-data"
				...
				<div class="row block-9 mb-4" style="padding-left:20px;">
					...
					<div class="select-wrap one-third theme">
						<h3 class="h4 mb-4">Name</h3> <input type="text" id="category_name" name="category_name"
							required="required">
					...
					<div class="select-wrap one-third theme">
						<h3 class="h4 mb-4">Content</h3><textarea id="category_content" name="category_content"
					...
					<a href="#" class="block-5" style="background-image: url('images/tour-1.jpg');">
						<div class="text">
							...
							<p class="star-rate"><span class="icon-star"></span><span class="icon-star"></span><span
									...
									class="icon-star-half-full"></span> <span>500 reviews</span></p>
						</div>
					</a>
				</div>
			</div>
