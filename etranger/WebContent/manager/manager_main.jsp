				...
				<div class="panel panel-info sticky" id="leftside">
					...
					<ul class="list-group">
						...
						<li class="list-group-item li_hover pList"><span
							class="icon icon-add_shopping_cart"></span> 상품 상세 등록</li>
					...
					<ul class="list-group" id="memberManagement">
						<li class="list-group-item li_hover member" onclick="location.href='MemberManagement.ma'">&nbsp;­회원예약</li>
								...
								<div class="row d-block flex-row">
									...
									<div class="select-wrap one-third">
										...
										<select id="selectRegion" class="form-control"
											onChange="showRegionAdd()" name="category_regioncode"
											required="required">
											<!-- 옵션 클릭시 select()동작 -->
											<option>지역선택</option>
						...
						+ regionList.get(i).getRegionName()%>
										...
										<div class="form-group" id="addRegion" style="display: none;">
											<input type="text" size="20" id="region_addbox"
												onkeydown="enterKey(this);"> <input type="button"
												id="region_addbtn" value="지역추가" class="btn btn-primary">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="select-wrap one-third">
									...
									<select id="selectCity" class="form-control"
										onChange="showCityAdd()" name="category_citycode"
										required="required">
										<option>도시선택</option>
										<option value="add">도시추가</option>
									</select>
									<div class="form-group" id="addCity" style="display: none;">
										<input type="text" size="20" id="city_addbox"
											onkeydown="enterKey(this);"> <input type="button"
											id="city_addbtn" value="도시추가" class="btn btn-primary">
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="select-wrap one-third theme">
									...
									<div id="test">
										...
										%>
										<label id="newTheme"> <input type="checkbox"
											name="theme" value="<%=themeList.get(i).getThemeName()%>"><%=themeList.get(i).getThemeName()%>
										</label>
										<%
											}
										%>
									...
									<div class="col-md-12">
										<input type="button" id="theme_addbtn" value="테마추가"
											class="btn btn-primary" onclick="check()">
										<div class="form-group" id="addTheme" style="display: none;">

											<input type="text" size="20" id="theme_addbox"
												onkeydown="enterKey(this);"> <input type="button"
												id="theme_addbtn2" class="btn btn-primary" value="추가">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="select-wrap one-third theme">
									...
									<textarea id="category_content" name="category_content"
										rows="20" cols="80" required="required"></textarea>
							...
							<div class="col-md-12">
								<div class="form-group" style="display: block; clear: both;">
									<br> &nbsp;&nbsp; <input type="submit" value="등록하기"
										...
										type="reset" value="다시쓰기" class="btn py-3 px-4 btn-primary">
								</div>
							</div>
						</div>
					</form>
