			...
			<div class="col-md-2">
				<div class="panel panel-info sticky">
					...
					<ul class="list-group">
						...
						<li class="list-group-item li_hover" onclick="dis()"><span class="icon icon-pencil"></span> 상품
							분류 등록</li>
						<li class="list-group-item li_hover"><span class="icon icon-add_shopping_cart"></span> 상품 상세 등록
						</li>
