...
<%--               		<a class="comment_reply_btn" href="#comment_reply_btn" onclick="replyComment('<%=commentList.get(i).getReview_comment_num() %>'); this.onclick='';">대댓글</a> --%>
...
<%--                 	<a class="comment_update_btn" href="#comment_update_btn" onclick="updateComment('<%=commentList.get(i).getReview_comment_num() %>','<%=commentList.get(i).getReview_comment_content()%>')">수정</a> --%>
