...
public class ReservationDAO {
	...
	public int insertReservation(ReservationBean rb) {
		...
		try {
			System.out.println(rb.getReservation_category_code());
			System.out.println(rb.getReservation_ispayment());
			System.out.println(rb.getReservation_pay_way());
			System.out.println(rb.getReservation_headcount());
			System.out.println(rb.getReservation_price());
			System.out.println(rb.getReservation_product_num());
			System.out.println(rb.getReservation_member_id());
...
//					+ "VALUES (?,?,CURRENT_TIMESTAMP,?,?,?,?,?)";
			...
			pstmt.setInt(3, rb.getReservation_price());
			pstmt.setInt(4, rb.getReservation_headcount());
			pstmt.setString(5, rb.getReservation_pay_way());
			pstmt.setString(6, rb.getReservation_ispayment());
			pstmt.setString(7, rb.getReservation_category_code());
